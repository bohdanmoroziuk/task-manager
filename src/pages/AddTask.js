            ...
            <form onSubmit={this.handleSubmit}>
                <div className="form-row">
                    ...
                    <div className="form-group col-md-6">
                        ...
                        <input className="form-control" type="date" name="deadline" id="deadline" min={today()} value={deadline} onChange={this.handleChange} />
                    </div>
                </div>
                <div className="form-row">
                    <div className="form-group col-md-12">
                        <label htmlFor="comment">Comment</label>
                        <textarea className="form-control" name="comment" id="comment" value={comment} onChange={this.handleChange}></textarea>
                    </div>
                </div>
                <div className="form-row">
                    <div className="col-md-12">
                        <button className="btn btn-dark" type="submit">Add Task</button>
                        <Link className="btn btn-dark ml-2" to="/">Cancel</Link>    
                    </div>
                </div>
            </form>
        );
